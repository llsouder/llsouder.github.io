...
var or__27765__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj36406 = {"detail":data};
return obj36406;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27753__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27753__auto__)){
var and__27753__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__36413 = cljs.core._EQ_;
var expr__36414 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36413.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36414))){
return ((function (pred__36413,expr__36414){
return (function (p1__36407_SHARP_){
return console.warn(p1__36407_SHARP_);
});
;})(pred__36413,expr__36414))
} else {
if(cljs.core.truth_(pred__36413.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36414))){
return ((function (pred__36413,expr__36414){
return (function (p1__36408_SHARP_){
return console.debug(p1__36408_SHARP_);
});
;})(pred__36413,expr__36414))
} else {
if(cljs.core.truth_(pred__36413.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36414))){
return ((function (pred__36413,expr__36414){
return (function (p1__36409_SHARP_){
return console.error(p1__36409_SHARP_);
});
;})(pred__36413,expr__36414))
} else {
return ((function (pred__36413,expr__36414){
return (function (p1__36410_SHARP_){
return console.log(p1__36410_SHARP_);
});
;})(pred__36413,expr__36414))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36417){
var map__36418 = p__36417;
var map__36418__$1 = ((((!((map__36418 == null)))?((((map__36418.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36418.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36418):map__36418);
var opts = map__36418__$1;
var eval_fn = cljs.core.get.call(null,map__36418__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__36420_SHARP_);
});})(new_def))
);
...
return (function (p__36421){
var vec__36422 = p__36421;
var ky = cljs.core.nth.call(null,vec__36422,(0),null);
var v = cljs.core.nth.call(null,vec__36422,(1),null);
...
if(cljs.core.truth_((function (){var and__27753__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1522528354845
