...
var o39755 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39755["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39756 = temp__4655__auto____$1;
return (o39756["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38866__auto__ = f;
return (o__38866__auto__["toString"]).call(o__38866__auto__);
} else {
return "";
}
}catch (e39757){var _ = e39757;
return "";
}});
...
try{var o__38866__auto___39759 = t;
(o__38866__auto___39759["cljs$lang$ctorPrWriter"]).call(o__38866__auto___39759,t,writer);
}catch (e39758){var __39760 = e39758;
}
...
var char_code = (function (){var o__38866__auto__ = (new String(char$));
return (o__38866__auto__["charCodeAt"]).call(o__38866__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38866__auto__ = String;
return (o__38866__auto__["fromCharCode"]).call(o__38866__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39761 = num_code;
switch (G__39761) {
case (1):
return (185);
...
var o__38866__auto__ = String;
return (o__38866__auto__["fromCharCode"]).call(o__38866__auto__,superscript_code);
});
/**
...
}catch (e39763){var _e__38873__auto__ = e39763;
return false;
}})())){
...
var vec__39764 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39764,(0),null);
...
var or__27765__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o39767 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39767["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39768 = temp__4655__auto____$1;
return (o39768["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28934__auto___39775 = arguments.length;
var i__28935__auto___39776 = (0);
while(true){
if((i__28935__auto___39776 < len__28934__auto___39775)){
args__28941__auto__.push((arguments[i__28935__auto___39776]));

var G__39777 = (i__28935__auto___39776 + (1));
i__28935__auto___39776 = G__39777;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28942__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39771){
var vec__39772 = p__39771;
var ns_detector = cljs.core.nth.call(null,vec__39772,(0),null);
var effective_detector = (function (){var or__27765__auto__ = ns_detector;
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
...
var G__39778 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39779 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39778;
remaining_tokens = G__39779;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39769){
var G__39770 = cljs.core.first.call(null,seq39769);
var seq39769__$1 = cljs.core.next.call(null,seq39769);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__39770,seq39769__$1);
});
...
var vec__39783 = cljs.core.split_with.call(null,(function (p1__39782_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39782_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39783,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39783,(1),null);
...
var vec__39786 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39786,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39786,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39789 = cljs.core.rest.call(null,remaining_tokens);
var G__39790 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39789;
name_tokens = G__39790;
continue;
} else {
...
var vec__39793 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39793,(0),null);
var arity = cljs.core.nth.call(null,vec__39793,(1),null);
var vec__39796 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39796,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39796,(1),null);
var vec__39799 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39799,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39799,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39799,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39799,(3),null);
...
var vec__39805 = result;
var munged_ns = cljs.core.nth.call(null,vec__39805,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39805,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39805,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39805,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39805,(4),null);
var arity = cljs.core.nth.call(null,vec__39805,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__39809 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__39809,(0),null);
var args = cljs.core.nth.call(null,vec__39809,(1),null);
var vec__39812 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39812,(0),null);
var name = cljs.core.nth.call(null,vec__39812,(1),null);
...
var G__39815 = (arity + (1));
var G__39816 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39817){
var vec__39818 = p__39817;
var arity = cljs.core.nth.call(null,vec__39818,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39818,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__27765__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__39821_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39822_SHARP_);
...
var args__28941__auto__ = [];
var len__28934__auto___39829 = arguments.length;
var i__28935__auto___39830 = (0);
while(true){
if((i__28935__auto___39830 < len__28934__auto___39829)){
args__28941__auto__.push((arguments[i__28935__auto___39830]));

var G__39831 = (i__28935__auto___39830 + (1));
i__28935__auto___39830 = G__39831;
continue;
} else {
}
break;
...
var argseq__28942__auto__ = ((((1) < args__28941__auto__.length))?(new cljs.core.IndexedSeq(args__28941__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28942__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39825){
var vec__39826 = p__39825;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39826,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39823){
var G__39824 = cljs.core.first.call(null,seq39823);
var seq39823__$1 = cljs.core.next.call(null,seq39823);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__39824,seq39823__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__27765__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__27753__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__27765__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39834__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39834__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39834__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39834__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39835 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39835,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39835,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39835,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39835,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39835,(4),null);
var arity = cljs.core.nth.call(null,vec__39835,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__27753__auto__ = protocol_ns;
if(cljs.core.truth_(and__27753__auto__)){
return cljs.core.not.call(null,(function (){var and__27753__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__27765__auto__ = protocol_part;
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
return fn_part;
...
var o__38866__auto__ = f;
return (o__38866__auto__["getBasis"]).call(o__38866__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__27753__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__27753__auto__)){
...
}catch (e39839){var _e__38873__auto__ = e39839;
...
var G__39840 = (obj[cljs.core.first.call(null,path)]);
var G__39841 = cljs.core.rest.call(null,path);
obj = G__39840;
path = G__39841;
continue;
} else {
...
var partition_bits = (function (){var or__27765__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
return (0);
...
return (function (accum,p__39842){
var vec__39843 = p__39842;
var bit = cljs.core.nth.call(null,vec__39843,(0),null);
var protocol = cljs.core.nth.call(null,vec__39843,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39846){
var vec__39847 = p__39846;
var ns = cljs.core.nth.call(null,vec__39847,(0),null);
var name = cljs.core.nth.call(null,vec__39847,(1),null);
var selector = cljs.core.nth.call(null,vec__39847,(2),null);
...
var matches__$1 = cljs.core.nth.call(null,vec__39852,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39852,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39850_SHARP_){
return (obj[cljs.core.first.call(null,p1__39850_SHARP_)]);
});})(name,sorted_matches,vec__39852,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1522528363173
