...
var G__39857 = devtools.prefs.pref.call(null,v);
v = G__39857;
continue;
} else {
return v;
...
var and__27753__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__27753__auto__){
var and__27753__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__27765__auto__ = (function (){try{if(!((value == null))){
...
}catch (e39860){var _e__38873__auto__ = e39860;
return false;
}})();
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
var or__27765__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e39864){var _e__38873__auto__ = e39864;
return false;
}})();
...
}catch (e39866){var _e__38873__auto__ = e39866;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__27753__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__27753__auto__)){
var and__27753__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__27753__auto____$1){
...
var and__27753__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__27753__auto__)){
...
var or__27765__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
...
var and__27753__auto__ = (function (){var or__27765__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
...
var vec__39868 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39868,(0),null);
var name = cljs.core.nth.call(null,vec__39868,(1),null);
...
var and__27753__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__27753__auto__)){
...
var or__27765__auto__ = typeof value === 'string';
if(or__27765__auto__){
return or__27765__auto__;
} else {
var or__27765__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__39871_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39871_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1522528363347
