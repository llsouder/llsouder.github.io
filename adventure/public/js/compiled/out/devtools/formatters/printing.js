...
var len__28934__auto___39886 = arguments.length;
var i__28935__auto___39887 = (0);
while(true){
if((i__28935__auto___39887 < len__28934__auto___39886)){
args__28941__auto__.push((arguments[i__28935__auto___39887]));

var G__39888 = (i__28935__auto___39887 + (1));
i__28935__auto___39887 = G__39888;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28942__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq39883){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__39884,G__39885,seq39883__$2);
});
...
if(cljs.core.truth_((function (){var or__27765__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__28390__auto__,writer__28391__auto__,opt__28392__auto__){
return cljs.core._write.call(null,writer__28391__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__27753__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__27753__auto__){
var or__27765__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__39889_SHARP_){
return !((cljs.core.meta.call(null,p1__39889_SHARP_) == null));
})))){
...
var map__39890 = opts;
var map__39890__$1 = ((((!((map__39890 == null)))?((((map__39890.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39890.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39890):map__39890);
var markup_db = cljs.core.get.call(null,map__39890__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__27765__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e39894){var _e__38873__auto__ = e39894;
return false;
}})();
if(cljs.core.truth_(or__27765__auto__)){
return or__27765__auto__;
...
}catch (e39896){var _e__38873__auto__ = e39896;
return false;
}}
})())){
...
var _STAR_current_state_STAR_39898 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__39899 = opts;
...
var markup_db = cljs.core.get.call(null,map__39899__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_39898;
}});
...
;
var temp__4655__auto___39903 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___39903)){
var managed_print_level_39904 = temp__4655__auto___39903;
var _STAR_print_level_STAR_39902_39905 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_39904;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_39902_39905,managed_print_level_39904,temp__4655__auto___39903,writer,opts,job_fn){
return (function (p1__39901_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__39901_SHARP_,null);
});})(_STAR_print_level_STAR_39902_39905,managed_print_level_39904,temp__4655__auto___39903,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_39902_39905;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1522528363566
