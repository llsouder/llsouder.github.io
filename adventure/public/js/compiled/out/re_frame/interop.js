...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__34284 = cljs.core.instance_QMARK_;
var expr__34285 = reactive_val;
if(cljs.core.truth_(pred__34284.call(null,reagent.ratom.RAtom,expr__34285))){
return "ra";
} else {
if(cljs.core.truth_(pred__34284.call(null,reagent.ratom.RCursor,expr__34285))){
return "rc";
} else {
if(cljs.core.truth_(pred__34284.call(null,reagent.ratom.Reaction,expr__34285))){
return "rx";
} else {
if(cljs.core.truth_(pred__34284.call(null,reagent.ratom.Track,expr__34285))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1522528346243
