...
var base_style__$1 = (cljs.core.truth_((function (){var and__27753__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__27753__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__27753__auto__)){
...
if(cljs.core.truth_((function (){var and__27753__auto__ = required_QMARK_;
if(cljs.core.truth_(and__27753__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__34184){
...
var on_change = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__34185__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__34185,map__34185__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__34181_SHARP_){
return item_renderer.call(null,p1__34181_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34185,map__34185__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__34185,map__34185__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__34182_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__34182_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34185,map__34185__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__34185,map__34185__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__34183_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__34183_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34185,map__34185__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__28934__auto___34194 = arguments.length;
var i__28935__auto___34195 = (0);
while(true){
if((i__28935__auto___34195 < len__28934__auto___34194)){
args__28941__auto__.push((arguments[i__28935__auto___34195]));

var G__34196 = (i__28935__auto___34195 + (1));
i__28935__auto___34195 = G__34196;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__28942__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__34188){
...
return ((function (map__34189,map__34189__$1,args){
return (function() { 
var G__34197__delegate = function (p__34191){
...
while (G__34198__i < G__34198__a.length) {G__34198__a[G__34198__i] = arguments[G__34198__i + 0]; ++G__34198__i;}
  p__34191 = new cljs.core.IndexedSeq(G__34198__a,0,null);
} 
return G__34197__delegate.call(this,p__34191);};
G__34197.cljs$lang$maxFixedArity = 0;
G__34197.cljs$lang$applyTo = (function (arglist__34199){
var p__34191 = cljs.core.seq(arglist__34199);
return G__34197__delegate(p__34191);
});
G__34197.cljs$core$IFn$_invoke$arity$variadic = G__34197__delegate;
return G__34197;
})()
;
;})(map__34189,map__34189__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq34187){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34187));
});


//# sourceMappingURL=selection_list.js.map?rel=1522528345308
