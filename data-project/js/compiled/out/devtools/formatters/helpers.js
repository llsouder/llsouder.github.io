...
var G__28445 = devtools.prefs.pref.call(null,v);
v = G__28445;
continue;
} else {
return v;
...
}catch (e28448){var _e__27462__auto__ = e28448;
return false;
}})();
...
}catch (e28452){var _e__27462__auto__ = e28452;
return false;
}})();
...
}catch (e28454){var _e__27462__auto__ = e28454;
return false;
}}
}
});
...
var vec__28456 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__28456,(0),null);
var name = cljs.core.nth.call(null,vec__28456,(1),null);
...
return cljs.core.some.call(null,(function (p1__28459_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28459_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1534123153768
