...
}catch (e30248){var _e = e30248;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___30251 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___30251)){
var seen_errors_30252 = temp__5455__auto___30251;
if(cljs.core.truth_(seen_errors_30252.has(self))){
} else {
seen_errors_30252.add(self);

var temp__5457__auto___30253 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___30253)){
var sense_30254 = temp__5457__auto___30253;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_30254)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1534123160454
