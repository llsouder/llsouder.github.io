...
var G__22605 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__22605;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__22606 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22606,ch);
...
if(("\\" === ch__$1)){
var ch_22607__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_22607__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_22607__$2);
} else {
}

var G__22608 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__22608;
continue;
}
}
...
var vec__22616 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22616,(0),null);
var start_column = cljs.core.nth.call(null,vec__22616,(1),null);
...
var G__22619 = cljs.core.conj_BANG_.call(null,a,form);
a = G__22619;
continue;
}
}
...
var _STAR_read_delim_STAR_22620 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_22620;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__22621 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22621,(0),null);
var start_column = cljs.core.nth.call(null,vec__22621,(1),null);
...
var vec__22624 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22624,(0),null);
var end_column = cljs.core.nth.call(null,vec__22624,(1),null);
...
var vec__22627 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22627,(0),null);
var start_column = cljs.core.nth.call(null,vec__22627,(1),null);
...
var vec__22630 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22630,(0),null);
var end_column = cljs.core.nth.call(null,vec__22630,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__22633,(0),null);
var start_column = cljs.core.nth.call(null,vec__22633,(1),null);
...
var vec__22636 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22636,(0),null);
var end_column = cljs.core.nth.call(null,vec__22636,(1),null);
...
var sb = (function (){var G__22639 = (new goog.string.StringBuffer());
G__22639.append(initch);
...
var G__22641 = (function (){var G__22640 = sb;
G__22640.append(ch);

return G__22640;
})();
var G__22642 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__22641;
ch = G__22642;
continue;
}
...
switch (G__22645) {
case "\\":
var G__22649 = (function (){var G__22646 = sb;
G__22646.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__22646;
})();
var G__22650 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22649;
ch = G__22650;
continue;
...
break;
default:
var G__22651 = (function (){var G__22647 = sb;
G__22647.append(ch);

return G__22647;
})();
var G__22652 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22651;
ch = G__22652;
continue;
...
var vec__22653 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22653,(0),null);
var end_column = cljs.core.nth.call(null,vec__22653,(1),null);
...
var vec__22656 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22656,(0),null);
var column = cljs.core.nth.call(null,vec__22656,(1),null);
...
var vec__22661 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22661,(0),null);
var column = cljs.core.nth.call(null,vec__22661,(1),null);
...
var vec__22666 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22666,(0),null);
var column = cljs.core.nth.call(null,vec__22666,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__22671 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22671,(0),null);
var start_column = cljs.core.nth.call(null,vec__22671,(1),null);
...
var vec__22674 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22674,(0),null);
var end_column = cljs.core.nth.call(null,vec__22674,(1),null);
...
var G__22677 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__22677,true,null,opts,pending_forms);
...
var G__22678 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__22678)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__22678)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__22678)){
...
var _STAR_suppress_read_STAR_22679 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_22679;
}});
...
var G__22680 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__22680,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__22680,rdr,first_line);
...
var G__22684 = matched;
var G__22685 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__22684;
finished = G__22685;
continue;
} else {
...
var _STAR_suppress_read_STAR_22686 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_22686;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env22687 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__22688 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22688,"(");
...
var G__22689 = (i + (1));
var G__22690 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env22687;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__22691 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__22691);
...
var G__22692 = cljs.core.next.call(null,s__$1);
var G__22693 = ret;
s__$1 = G__22692;
r = G__22693;
continue;
...
var G__22694 = cljs.core.next.call(null,s);
var G__22695 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__22694;
key_vals = G__22695;
continue;
} else {
...
var gensym_env22699 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env22699;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__22700 = token;
var G__22700__$1 = (((G__22700 == null))?null:cljs.core.subs.call(null,G__22700,(1)));
var G__22700__$2 = (((G__22700__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22700__$1));
var G__22700__$3 = (((G__22700__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22700__$2));
var G__22700__$4 = (((G__22700__$3 == null))?null:cljs.core.symbol.call(null,G__22700__$3));
if((G__22700__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__22700__$4);
}
})():(function (){var G__22701 = token;
var G__22701__$1 = (((G__22701 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22701));
if((G__22701__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22701__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__22712,reader){
...
var eof = cljs.core.get.call(null,map__22713__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq22719){
...
//# sourceMappingURL=reader.js.map?rel=1534123141957
